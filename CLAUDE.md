...
이 레포의 운영 규칙은 `AGENTS.md`와 `docs/` 문서를 정본으로 사용합니다. Claude Code에서 작업할 때도 먼저 `AGENTS.md`를 읽고, 그 안에 연결된 가이드 문서를 따른 뒤 작업하세요.

특히 새 글 작성, 사진 처리, 금지 표현, 배포 흐름은 아래 문서를 기준으로 합니다.
